...
const Signup = () => {
    ...
    return (
        <div className=" w-full h-[100vh] flex">
            <div className=" bg-gradient-to-b relative left from-[#DA9658] to-[#91643B] h-[101vh] w-[100vw]">
            ...
            <div className=" right ease-in transition-all delay-300 mx-auto w-[780px] flex flex-col items-center justify-center pt-[20px]">
                ...
                <form ref={formRef} onSubmit={(e) => handleSignup(e)} className=" form h-[80vh] opacity-0 ease-in transition-all delay-300 mx-auto flex flex-col gap-[16px]" action="">
                    {!isNewUser &&
                        <label className=" w-full items-start justify-start flex gap-[8px] flex-col" htmlFor="">
                            ...
                            <div className=" border-[#bfc5d0d3] p-4 rounded-lg border gap-[8px] flex items-center">
                                <AiOutlineUser className=" text-[#bfc5d0d3]" /><input required={true} type="text" className=" outline-none w-[412px]" placeholder="Steven Ade***" value={fullName} onChange={(e) => setFullName(e.target.value)} />
                            </div>
                        </label>
                    }
                    ...
                    <label className=" w-full items-start justify-start flex gap-[8px] flex-col" htmlFor="">
                        User Name
                        <div className=" border-[#bfc5d0d3] p-4 rounded-lg border gap-[8px] flex items-center">
                            <AiOutlineUser className=" text-[#bfc5d0d3]" /><input required={true} type="text" className="outline-none w-[412px]" placeholder="Steven Ade***" value={userName} onChange={(e) => setUserName(e.target.value)} />
                        </div>
                    </label>
                    ...
                    {!isNewUser &&
                        <label className=" w-full items-start justify-start flex gap-[8px] flex-col" htmlFor="">
                            Email
                            <div className=" border-[#bfc5d0d3] p-4 rounded-lg border gap-[8px] flex items-center">
                                <AiOutlineMail className=" text-[#bfc5d0d3]" /><input required={true} type="email" className=" outline-none w-[412px]" placeholder="Steven***@gmail.com" value={email} onChange={(e) => setEmail(e.target.value)} />
                            </div>
                        </label>
                    }
                    {!isNewUser &&
                    ...
                    <label className=" w-full items-start justify-start flex gap-[8px] flex-col" htmlFor="">
                        Password
                        <div className=" border-[#bfc5d0d3] p-4 rounded-lg border gap-[8px] flex items-center">
                            <AiOutlineLock className="text-[#bfc5d0d3]" size={20} /><input required={true} type="password" className=" outline-none w-[412px]" placeholder="Password" value={password} onChange={(e) => setPassword(e.target.value)} />
                        </div>
                        {isNewUser &&
