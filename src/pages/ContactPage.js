...
const ContactPage = () => {
    ...
    return (
        <div className='pt-[35px] lg:pt-[144px] pb-[5rem] h-full bg-[#FDFAF7]'>
            <Header />

            <div className='mb-[40px] px-[24px] lg:px-[45.5px] rounded-[16px] py-[40px] mx-[8px] lg:mx-[80px] bg-white text-[#1D1E20] grid gap-[24px] md:gap-0 lg:gap-[69px] lg:grid-cols-2 justify-center items-start'>
                <div className='w-full mt-0 md:mt-[1rem] lg:w-[536px]'>
                    <h1 className='text-[32px] mb-[8px] md:text-start  text-center lg:mb-[16px] font-[600]'>Contact Us</h1>
                    <p className='hidden lg:block text-[14px] leading-[21px]'>We Appreciate Your Feedback <br />
                        ...
                        <br className='size-[8px] lg:size-[16px]' />
                        <br className='size-[8px] lg:size-[16px]' />
                        <br className='size-[8px] lg:size-[16px]' />
                ...
                <div className='w-full lg:w-[584px] px-[12px] lg:px-[24px] rounded-[8px] border border-[#B4B9C2] py-[15px] lg:py-[40px]'>
                    ...
                    <form onSubmit={handleSubmit} className='flex flex-col gap-[16px] w-full mt-[50px]'>
                        <div className='flex lg:flex-row flex-col gap-[16px] w-full items-start'>
                        ...
                        <button
                            className='px-[12px] flex text-[14px] my-[18px] font-[500] py-[8px] w-full lg:w-[412px] lg:py-[16px] bg-[#DA9658] text-center justify-center items-center text-white rounded-[8px]'
                            type="submit"
                        >
                            {loading ? (
