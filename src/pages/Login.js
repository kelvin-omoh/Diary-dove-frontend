...
const Login = () => {
  ...
  return (
    <div className=" w-full h-[100vh] flex">
      ...
      <div className="right ease-in h-full my-auto transition-all delay-300 mx-auto w-[780px] flex flex-col items-center justify-center pt-[20px]">
        ...
        <form ref={formRef} onSubmit={handleSubmit} className="form opacity-0  ease-in transition-all delay-300 mx-auto flex flex-col gap-[16px]">
