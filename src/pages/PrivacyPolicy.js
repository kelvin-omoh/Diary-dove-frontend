...
const PrivacyPolicy = () => {
    return (
        <div className=' '>
            ...
            <Header />
            <Hero />
            <section id="services" className=' px-[24px] lg:px-[234px] overflow-hidden md:pb-[80px] pb-[64px] py-[35px] lg:pt-[95px]   ' >
                <div className='pb-[20px] md:pb-[40px]'>
                    ...
                    <p className=' text-[14px] md:text-[18px]'>For the purpose of this Policy:
                        ...
                        <span className='py-[20px] md:py-[40px]'>
                ...
                <div className='pb-[20px] md:pb-[40px]'>
                    <h1 className=' font-[500] text-[16px] md:text-[24px] leading-9'>Consent</h1>
                ...
                <div className='pb-[20px] md:pb-[40px]'>
                    <h1 className=' font-[500] text-[16px] md:text-[24px] leading-9'>Collection of Personal Data</h1>
                    <p className=' text-[14px] md:text-[18px]'>
                    ...
                    <ul className=' pt-[20px] md:pt-[40px] flex flex-col gap-[2rem] list-disc '>
                        <li>
                        ...
                        <li>
                            Social Media: We also receive information through your engagements with us on social media sites (e.g., Facebook, Instagram, LinkedIn, Twitter, etc). These include but are not limited to your replies to our posts, your comments, enquiries, messages to us, etc. We may also collect information from your public profile and updates on social media.
                ...
                <div className='pb-[20px] md:pb-[40px]'>
                    <h1 className=' font-[500] text-[16px] md:text-[24px] leading-9'>Accessing your Personal Information</h1>
                    <p className=' text-[14px] md:text-[18px]'> When accessing our Software, we may collect information about you and your interactions with the Services which we undertake to keep secure and confidential.
                ...
                <div className='pb-[20px] md:pb-[40px]'>
                    ...
                    <p className=' text-[14px] md:text-[18px]'>
                        ...
                        <span >
                            <ul className='py-[20px] md:py-[40px]'>
                                <li>DairyDove Ltd</li>
                                <li className="underline decoration-2 decoration-[#b3b3b3]">www.dairydove.com</li>
                                <li>371 Agege Motor Road, Challenge Plaza</li>
                                <li>Challenge Bus stop, Papa Ajao, Lagos</li>
                                <li>Lagos, Nigeria</li>
                                <li> Email: hello@diarydove.com</li>
                                <li> Phone number: +234 810 759 5941</li>
                            </ul>
                        </span>

                        Please allow up to 7 working days days for requests to be processed. The Company reserves the right to charge a reasonable fee to process excessive or repeated requests.
                    </p>
                </div>
