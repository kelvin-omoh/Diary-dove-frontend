...
const Hero = () => {
    ...
    return (
        <div data-aos="fade-in" className=' bg-[#DA9658] overflow-hidden relative h-[642px]   md:h-[1108px] w-full   text-white'>
            ...
            <div>
                <img src={vector} className=' absolute  top-[68px] md:top-[157px] md:left-[80px] left-[-33px]  h-[69px] md:w-[130px] md:h-[106px]  ' alt="" />
                <img src={vector} className=' absolute left-[338px] md:left-[90%] top-[343px] md:top-[796px] md:w-[130px] md:h-[106px] w-[84px]  h-[69px]  ' alt="" />
                <img src={vector} className=' absolute top-[486px] md:top-[949px] left-[-42px] md:left-[-65px]  w-[84px] h-[69px] md:w-[130px] md:h-[106px]  ' alt="" />
            </div>
        </div>
    )
}
