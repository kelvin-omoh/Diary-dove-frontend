...
const Hero = () => {
    ...
    return (
        <div className=' overflow-x-hidden relative  flex flex-col  px-[10px] md:px-[120px]  md:flex-row items-center justify-center gap-0 md:gap-[56px] pt-[4.4rem] mt-[43px]'>
