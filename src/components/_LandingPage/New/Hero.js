...
const Hero = () => {
    return (
        <div className=' flex flex-col  px-[10px] md:px-[120px]  md:flex-row items-center justify-center gap-0 md:gap-[56px] pt-[4.4rem] mt-[43px]'>
            <div className='  w-[644px] text-center'>
                ...
                <button className=' bg-[#B4B9C2] text-white py-[8px] px-[32px] rounded-[8px] mt-[32px]'>Sign up for free</button>
            </div>
            <div>
