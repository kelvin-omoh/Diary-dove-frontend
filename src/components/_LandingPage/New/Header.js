...
const Header = () => {
    ...
    return (
        <div style={{ boxShadow: '0px 0px 12px 0px #00000014' }} className='z-10  fixed top-0 w-[100vw] flex flex-row items-center py-[16px] justify-start md:justify-between px-[24px] md:px-[80px] bg-white'>
