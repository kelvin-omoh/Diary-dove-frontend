        ...
        <>
            {toggle && (
                <div
                    ...
                    className="z-[100] block md:hidden fixed bg-[#000000B2] w-full h-full"
                ></div>
            )}
            <div
                className={` ${toggle ? " left-0 opacity-[1] " : " left-[-100vw] "
                    }  md:opacity-[1] z-[100] ease-in-out  duration-300  opacity-0 transition-all bg-[#DA9658] text-white text-start flex justify-start flex-col md:left-0 fixed h-[100vh] top-0 shadow-xl w-[226px] md:w-full pl-[24px] md:pl-[80px]`}
            >
                <div
                    className={` ${toggle ? " left-0 opacity-[1] " : " left-[-100vw] "
                        }  md:opacity-[1] z-[100] ease-in-out  duration-300  opacity-0 transition-all  text-white text-start flex justify-start flex-col md:left-0 fixed h-[100vh] top-0 shadow-sm w-[226px] md:w-[320px] pl-[24px] md:pl-[80px]`}
                >
                    ...
                    <div className="mt-[160px] md:mt-[173px] w-[321px-80px]  flex justify-end pr-[-3rem] md:pr-[9px]">
                        ...
                        <div className="absolute bottom-[24px] md:bottom-[-40px] left-[24px]">
                            ...
                            <button
                                onClick={() => logOut()}
                                className="md:hidden text-[18px] font-[500] flex items-center gap-[14.25px] mb-[17.25px] mt-[25.5px]"
                            >
                                <img
                                    src={logoutIcon}
                            ...
                            <img
                                className="absolute md:relative md:bottom-0 bottom-[-100px] left-[-57px] h-[89px]"
                                src={vector}
                                alt=""
                            />
                        </div>
