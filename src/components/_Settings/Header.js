...
const Header = () => {
    ...
    return (
        ...
        <div className='  rounded-none md:rounded-tl-[48px] fixed w-full md:w-[80vw]  bg-white px-[24px] md:px-[80px] top-[0px] py-[26px] flex justify-between z-[50]  shadow-md shadow-[#f1f1f1e1] items-center h-[88px] '>
            <Link to="/dashboard">
